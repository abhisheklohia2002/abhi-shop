...
import { getRandomBotResponse } from "../data/dummyData";
...
const initialMessages: Message[] = [
  {
    id: "welcome",
    text: "Hi there! 👋 I'm Nova, your AI assistant. How can I help you today?",
    sender: "bot",
    timestamp: new Date(),
  },
];
      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-blue-800 text-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 py-16 relative z-10">
          <div className="max-w-2xl">
            ...
            <p className="text-xl mb-8">{banners[currentBanner].subtitle}</p>
            <Link
              to="/products/all"
          ...
          <div className="bg-white rounded-lg p-6 border border-gray-200 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                All products are 100% genuine and certified
              </p>
            </div>
          </div>
          <div className="bg-white rounded-lg p-6 border border-gray-200 flex items-start gap-4">
